...
var defaults = {
  ...
  methods : {
    init : function(options) {
      ...
      var uniqueForms =
          $.unique($siblingElements
                       .map(function() { return $(this).parents("form")[0]; })
                       .toArray());
      ...
      return this.each(function() {
        ...
        if (settings.options.sniffHtml) {
          ...
          if ($this.attr("maxlength") !== undefined) {
            message =
                "Too long: Maximum of '" + $this.attr("maxlength") +
          ...
          if ($this.attr("minlength") !== undefined) {
            message =
                "Too short: Minimum of '" + $this.attr("minlength") +
        ...
        do // repeatedly expand 'shortcut' validators into their real validators
        {
          ...
          $.each(validatorNames,
              function(i, el) { validatorNames[i] = formatValidatorName(el); });
          ...
          $.each(validatorNamesToInspect, function(i, el) {
            if ($this.data("validation" + el + "Shortcut") !== undefined) {
              ...
              $.each($this.data("validation" + el + "Shortcut").split(","),
                  function(i2, el2) { newValidatorNamesToInspect.push(el2); });
        ...
        $.each(validatorNames, function(i, el) {
          ...
          if (!foundValidator && settings.builtInValidators[el.toLowerCase()]) {
            ...
            if (validatorType === "shortcut") {
              ...
              $.each(settings.validatorTypes, function(validatorTemplateType,
                                                  validatorTemplate) {
        ...
        $helpBlock.data(
            "original-contents", ($helpBlock.data("original-contents")
        ...
        $controlGroup.data(
            "original-classes", ($controlGroup.data("original-clases")
        ...
        $this.bind(
            "getValidators.validation", function() { return validators; });
            ...
            function(e, params) {
              ...
              $controlGroup.find("input,textarea,select").each(function(i, el) {
                ...
                $.each($(el).triggerHandler("validation.validation", params),
                    function(j, message) { errorsFound.push(message); });
        ...
        $this.bind("validationLostFocus.validation",
            function() { $controlGroup.removeClass("success"); });
      });
    },
    destroy : function() {
      return this.each(function() {
    ...
    override : function(
        newDefaults) { defaults = $.extend(true, defaults, newDefaults); }
  },
  validatorTypes : {
    callback : {
      name : "callback",
          ...
          executeFunctionByName(
              validator.callback, window, $this, value, function(data) {
                if (rrjqbvValidator.lastValue === data.value) {
                  ...
                  setTimeout(
                      function() { rrjqbvThis.trigger("change.validation"); },
          ...
          $.ajax({
            ...
            success : function(data) {
              if ("" + validator.lastValue === "" + data.value) {
                ...
                validator.lastFinished = true;
                $this.data("validation" + validator.validatorName + "Message",
                    validator.message);
                // Timeout is set to avoid problems with the events being
                // considered 'already fired'
    ...
    required : {
      name : "required",
      init : function($this, name) { return {}; },
      validate : function($this, value, validator) {
    ...
    min : {
      name : "min",
      init : function($this,
          name) { return {min : $this.data("validation" + name + "Min")}; },
      validate : function($this, value, validator) {
...
var getValue = function($this) {
  ...
  if (type === "radio") {
    value = ($('input[name="' + $this.attr("name") + '"]:checked').length > 0
                 ? value
                 : "");
  }
  return value;
