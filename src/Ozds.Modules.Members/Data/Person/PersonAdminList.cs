  ...
  public void Build(QueryEngineBuilder<ContentItem> builder) =>
    builder
      ...
      .WithDefaultTerm(
        "text",
        builder => builder
          .ManyCondition((value, query, context) => Task
            .Run<IQuery<ContentItem>?>(() => context
              .As<ContentQueryContext>()
              .WhenNonNullable(content => content.ServiceProvider
                .GetRequiredService<IHttpContextAccessor>()
                .HttpContext
                .WhenNonNullable(httpContext => httpContext
                  .Request
                  .RouteValues
                  ...
                  .When(selectedContentType =>
                    ...
                    () => query
                      ...
                      .As<IQuery<ContentItem>>()))))
            .ToValueTask(),
          (value, query, context) => Task
            .Run<IQuery<ContentItem>?>(() => query
              .With<ContentItemIndex>(index => index.DisplayText
                .IsNotIn<ContentItemIndex>(
