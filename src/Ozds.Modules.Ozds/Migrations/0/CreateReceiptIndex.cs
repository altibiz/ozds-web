  ...
  public static ISchemaBuilder CreateReceiptMapTable(
    ...
    schema.CreateMapIndexTable<ReceiptIndex>(
      table => table
        ...
        .Column<string>("ConsumerContentItemId", column => column.WithLength(250))
        .Column<string>("ConsumerUserId", column => column.WithLength(250))
        .Column<string>("ConsumerName", column => column.WithLength(250))
        .Column<string>("ConsumerOib", column => column.WithLength(30))
        .Column<string>("CenterContentItemId", column => column.WithLength(250))
        .Column<string>("CenterUserId", column => column.WithLength(250))
