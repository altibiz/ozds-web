...
function asyncGeneratorStep(e, r, t, n, a, o, i) {
  ...
  s.done ? r(u) : Promise.resolve(u).then(n, a);
}
...
var getDashboardMeasurementsByDevice = (function () {
              ...
              case 0:
                return (
                  ...
                  query({
                    ...
                    variables: { deviceId: r, period: serializePeriod(t) },
                  })
                );
              case 2:
                if ((n = e.sent)) {
              ...
              case 5:
                return e.abrupt(
                  ...
                  normalizeDashboardMeasurements(
                    n.data.dashboardMeasurementsByDevice,
                  ),
                );
              case 6:
              case "end":
  ...
  getDashboardMeasurementsByOwner = (function () {
    var e = _asyncToGenerator(
      regeneratorRuntime.mark(function e(r, t) {
        var n;
        return regeneratorRuntime.wrap(function (e) {
              ...
              case 0:
                return (
                  ...
                  query({
                    ...
                    variables: { ownerId: r, period: serializePeriod(t) },
                  })
                );
              case 2:
                if ((n = e.sent)) {
              ...
              case 5:
                return e.abrupt(
                  ...
                  normalizeMultiDashboardMeasurements(
                    n.data.dashboardMeasurementsByOwner,
                  ),
                );
              case 6:
              case "end":
  ...
  getDashboardMeasurementsByOwnerUser = (function () {
    var e = _asyncToGenerator(
      regeneratorRuntime.mark(function e(r, t) {
        var n;
        return regeneratorRuntime.wrap(function (e) {
            ...
            switch ((e.prev = e.next)) {
              case 0:
                return (
                  ...
                  query({
                    ...
                    variables: { ownerUserId: r, period: serializePeriod(t) },
                  })
                );
              case 2:
                if ((n = e.sent)) {
              ...
              case 5:
                return e.abrupt(
                  "return",
                  normalizeMultiDashboardMeasurements(
                    n.data.dashboardMeasurementsByOwnerUser,
                  ),
                );
              case 6:
              case "end":
  ...
  normalizeDashboardMeasurements = function (e) {
    return e
      .map(function (e) {
        return _objectSpread(
          _objectSpread({}, e),
          {},
          { timestamp: deserializeDateTime(e.timestamp) },
        );
      })
      .sort(function (e, r) {
        return compareDateTime(e.timestamp, r.timestamp);
      });
  },
  normalizeMultiDashboardMeasurements = function (e) {
    return (
        ...
        return (
          e[
            (r = _objectSpread(
              _objectSpread({}, r),
              {},
              { timestamp: deserializeDateTime(r.timestamp) },
            )).deviceId
          ] || (e[r.deviceId] = []),
          e[r.deviceId].push(r),
          e
  ...
  deserializePeriod = function (e) {
    return { from: deserializeDateTime(e.from), to: deserializeDateTime(e.to) };
  },
  serializePeriod = function (e) {
    return { from: serializeDateTime(e.from), to: serializeDateTime(e.to) };
  },
  deserializeDateTime = function (e) {
    return luxon.DateTime.fromISO(e, { zone: "utc" });
  },
  serializeDateTime = function (e) {
    return e.toISO();
  },
  query = (function () {
    var e = _asyncToGenerator(
  ...
  compareDateTime = function (e, r) {
    return e.toMillis() - r.toMillis();
  },
  gql = function (e) {
    return e[0];
  };
