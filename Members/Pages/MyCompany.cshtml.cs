...
namespace Members.Pages
{
  public class MyCompanyModel : PageModel
  {
    ...
    public async Task OnGetAsync(string companyId)
    {
      ...
      DocLink = string.Format(
          "https://altibizhtml2pdf.azurewebsites.net/api/generatePdf?code=bPJSYSigg05QxJvYAsqPr584dwV897UbUialY99kTzNvtEt5lzBSkw==&fileName={0}&url={1}",
          fileName, docUrl);
    }
