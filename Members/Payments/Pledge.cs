...
namespace Members.Payments {
  ...
  public static class PledgeMigrations {
    public static void
    CreatePledge(this IContentDefinitionManager _contentDefinitionManager) {
      ...
      _contentDefinitionManager.AlterTypeDefinition(
          "PledgeVariant",
          type =>
              type.DisplayedAs("Vrijednost uplate")
                  .Creatable()
                  .WithPart(nameof(PledgeVariant),
      ...
      _contentDefinitionManager.AlterPartDefinition(
          nameof(PledgeVariant),
          part => part.WithField(
              "Price", field => field.OfType("NumericField")
