...
namespace Members.Payments {
  ...
  public static class PledgeMigrations {
    public static void CreatePledge(
      ...
      _contentDefinitionManager.AlterPartDefinition(nameof(Pledge),
          part =>
              part.WithField("Amount",
                  ...
                  .WithField(
                      "Note", field => field.OfType("TextField")
      ...
      _contentDefinitionManager.AlterTypeDefinition("PledgeVariant",
      ...
      _contentDefinitionManager.AlterPartDefinition(nameof(PledgeVariant),
