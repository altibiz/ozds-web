...
public class Startup {
  ...
  public void ConfigureServices(IServiceCollection services) {
    ...
    services.AddSingleton<Ozds.Elasticsearch.IClientPrototype,
        Ozds.Elasticsearch.Client>();
    services.AddScoped<Ozds.Elasticsearch.IClient>(
        s => s.GetRequiredService<Ozds.Elasticsearch.IClientPrototype>()
                 .ClonePrototype(
                     s.GetRequiredService<ITestOutputHelperAccessor>()
                         .Output?.GetTest()
                         ?.GetCorrespondingIndexName()));

    services.AddSingleton<Ozds.Elasticsearch.HelbOzds.IClient,
        Ozds.Elasticsearch.HelbOzds.Client>();
        services.AddSingleton<Ozds.Elasticsearch.MyEnergyCommunity.IClient,
            Ozds.Elasticsearch.MyEnergyCommunity.Client>();
        services.AddSingleton<Ozds.Elasticsearch.MeasurementFaker.IClient,
