...
namespace OrchardCore.Themes.UgpTheme {
  public class ResourceManagementOptionsConfiguration
    ...
    static ResourceManagementOptionsConfiguration() {
      ...
      _manifest.DefineScript("ugptheme-bootstrap-bundle")
          .SetCdn(
      ...
      _manifest.DefineScript("ugptheme-jQuery")
          .SetCdn("https://code.jquery.com/jquery-3.4.1.min.js",
      ...
      _manifest.DefineStyle("ugptheme-bootstrap-oc")
          .SetUrl("~/UgpTheme/css/bootstrap-oc.min.css",
              "~/UgpTheme/css/bootstrap-oc.css")
          .SetVersion("1.0.0");

      _manifest.DefineScript("ugptheme")
          .SetDependencies("ugptheme-bootstrap-bundle")
          .SetUrl("~/UgpTheme/js/scripts.min.js", "~/UgpTheme/js/scripts.js")
          .SetVersion("6.0.0");

      _manifest.DefineScript("ugptheme-custom")
          .SetDependencies("ugptheme-jQuery")
          .SetUrl("~/UgpTheme/js/custom.js")
          .SetVersion("6.0.0");

      _manifest.DefineScript("ugptheme-libbcmath")
          .SetUrl("~/UgpTheme/js/libbcmath.js");
      _manifest.DefineScript("ugptheme-bcmath")
          .SetUrl("~/UgpTheme/js/bcmath.js");
      _manifest.DefineScript("ugptheme-pdf417")
          .SetUrl("~/UgpTheme/js/pdf417.js")
          .SetVersion("1.0.005");

      _manifest.DefineStyle("ugptheme")
